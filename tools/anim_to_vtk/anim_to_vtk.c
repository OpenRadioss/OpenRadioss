...
// g++ -DLINUX -o anim_to_vtk.linux64.exe anim_to_vtk.c
...
void readRadiossAnim(char *fileName)
{
    ...
    uint16_t *skewShortValA;              // array of the skew values defined in uint16_t * 3000 ;
    ...
    uint16_t *normShortA;                 // facet normal in uint16_t : array of 3*nbNodes
