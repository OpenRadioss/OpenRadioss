...
!||====================================================================
      module nodal_arrays_mod
        ...
        type nodal_arrays_
          ...
          real(kind=wp), dimension(:,:), allocatable :: FORCES !< forces (used for coupling only)
...
! ----------------------------------------------------------------------------------------------------------------------
          ...
          if(iparith == 0) then
            ...
            call my_alloc(arrays%STIFR,max(numnod*iroddl*nthreads,nthreads))
...
!                                                   Arguments
! ----------------------------------------------------------------------------------------------------------------------
          type(nodal_arrays_), intent(in) :: arrays !< nodal arrays
