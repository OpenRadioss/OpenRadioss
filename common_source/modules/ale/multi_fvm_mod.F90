...
!||====================================================================
      module multi_fvm_mod
        ...
        type face_data_struct
          ...
          real(kind=WP), dimension(:, :, :), allocatable :: normal, wfac
          real(kind=WP), dimension(:, :, :), allocatable :: centroid
        ...
        type fvm_inlet_data_struct
          ...
          real(kind=WP), dimension(3) :: val_vel
          real(kind=WP), dimension(21) :: val_alpha,val_rho,val_pres
...
!     compression coefficient for phase advection
          real(kind=WP) :: beta
          real(kind=WP) :: pres_shift
          integer :: nelem
          integer, dimension(:, :), allocatable :: n4_vois
          real(kind=WP), dimension(:, :, :), allocatable :: fluxes, subvol_fluxes, submass_fluxes, subener_fluxes
          real(kind=WP), dimension(:, :), allocatable :: vel
          real(kind=WP), dimension(:, :), allocatable :: acc
          real(kind=WP), dimension(:), allocatable :: sound_speed
          ...
          logical :: lowmach_opt
          ! muscl variables
          real(kind=WP), dimension(:, :), allocatable :: grad_rho, grad_u, grad_v, grad_w, grad_pres
          real(kind=WP), dimension(:, :), allocatable :: phase_alpha, phase_pres, phase_rho, phase_eint
          real(kind=WP), dimension(:, :, :), allocatable :: phase_grad_rho, phase_grad_alpha, phase_grad_pres
          ! ebcs
          ...
          ! size : numnod + numels
          real(kind=WP), dimension(:), allocatable :: x_append
          real(kind=WP), dimension(:), allocatable :: v_append
          real(kind=WP), dimension(:), allocatable :: mass_append
          ...
          real(kind=WP), dimension(:,:), allocatable :: force_int
