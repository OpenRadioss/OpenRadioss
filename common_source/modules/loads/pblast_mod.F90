...
!Copyright>        commercial version may interest you: https://www.altair.com/radioss/.
      ...
      MODULE PBLAST_MOD
        ...
        type friedlander_params_
          real(kind=WP) :: p_inci     !< incident pressure (positive phase)
          real(kind=WP) :: p_inci_    !< incident pressure (positive phase)
          real(kind=WP) :: p_refl     !< reflected pressure (negative phase)
          real(kind=WP) :: p_refl_    !< reflected pressure (negative phase)
          real(kind=WP) :: i_inci     !< incident impulse (positive phase)
          real(kind=WP) :: i_inci_    !< incident impulse (negative phase)
          real(kind=WP) :: i_refl     !< reflected impulse (positive phase)
          real(kind=WP) :: i_refl_    !< reflected impulse (negative phase)
          real(kind=WP) :: t_a        !< arrival time
          real(kind=WP) :: dt_0       !< duiration of positive phase
          real(kind=WP) :: dt_0_      !< duration of negative phase
          real(kind=WP) :: decay_inci !< decay parameter for incident wave
          real(kind=WP) :: decay_refl !< decay parameter for reflected wave
        ...
        type pblast_data_
          ...
          !-----------------------------------------------------------!
          real(kind=WP) :: rw3(256),ta(256),t0(256),t0_(256)
          real(kind=WP) :: pr(256),pr_(256),irefl(256),irefl_(256)
          real(kind=WP) :: pso(256),pso_(256),iso(256),iso_(256)
          !-----------------------------------------------------------!
          ...
          !-----------------------------------------------------------!
          real(kind=WP) :: rw3_surf(256),ir_surf(256),iso_surf(256),pr_surf(256),pso_surf(256),t0_surf(256),ta_surf(256)
...
! figure 2_13 scale height of trople point versus scaled horizontal distance  cm/g**1/3
          ...
          ! domain of definition starts only on Z >> Z0 ; first points are then filled with minimal value
          pblast_data%shtp(4,1:256) = (/&
          &6.9596407474e-02, 6.9596407474e-02, 6.9596407474e-02, 6.9596407474e-02, 6.9596407474e-02,&
          &6.9596407474e-02, 6.9596407474e-02, 6.9596407474e-02, 6.9596407474e-02, 6.9596407474e-02,&
          &6.9596407474e-02, 6.9596407474e-02, 6.9596407474e-02, 6.9596407474e-02, 6.9596407474e-02,&
          &6.9596407474e-02, 6.9596407474e-02, 6.9596407474e-02, 6.9596407474e-02, 6.9596407474e-02,&
          &6.9596407474e-02, 6.9596407474e-02, 6.9596407474e-02, 1.5625491062e-01, 2.4280354519e-01,&
          ...
          &2.8146041705e-03, 2.8146041705e-03, 2.8146041705e-03, 2.8146041705e-03, 2.8146041705e-03,&
          &2.8146041705e-03, 2.8146041705e-03, 2.8146041705e-03, 2.8146041705e-03, 2.8146041705e-03,&
          &2.8146041705e-03, 2.8146041705e-03, 2.8146041705e-03, 2.8146041705e-03, 2.8146041705e-03,&
          ...
          &5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02,&
          &5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02,&
          &5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02,&
          &5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02,&
          &5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02, 5.7890220823e-02,&
          ...
          &4.7129429080e-03, 4.7129429080e-03, 4.7129429080e-03, 4.7129429080e-03, 4.7129429080e-03,&
          &4.7129429080e-03, 4.7129429080e-03, 4.7129429080e-03, 4.7129429080e-03, 4.7129429080e-03,&
          &4.7129429080e-03, 4.7129429080e-03, 4.7129429080e-03, 4.7129429080e-03, 4.7129429080e-03,&
          &4.7129429080e-03, 4.7129429080e-03, 4.7129429080e-03, 4.7129429080e-03, 1.6749192600e-02,&
          ...
          &1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01,&
          &1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01,&
          &1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01,&
          &1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01,&
          &1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01, 1.1239390533e-01,&
          ...
          &2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03,&
          &2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03,&
          &2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03,&
          &2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03,&
          &2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03,&
          ...
          &2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03,&
          &2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03, 2.5403585557e-03,&
          &2.5403585557e-03, 2.5403585557e-03, 3.2518432381e-02, 6.2501672243e-02, 9.2475450017e-02,&
          ...
          &8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01,&
          &8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01,&
          &8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01,&
          &8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01,&
          &8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01, 8.3773489176e-01,&
...
! ----------------------------------------------------------------------------------------------------------------------
          ...
          real(kind=WP),intent(in) :: z,w13,tdet
...
! ----------------------------------------------------------------------------------------------------------------------
          ...
          real(kind=WP) :: bound1,bound2,phi_db,lambda,logres,tol,zeta,res,tmp2,tmp3,kk,funct,diff
...
!-----------------------------------------------
          ...
          if(zg > pblast%pblast_data%shdc(2,curve_id1))then
            ...
            if(is_output_enabled)then
              ...
              write(iout,fmt='(A)')msgout
              write(istdo,fmt='(A)')msgout
              zg =  pblast%pblast_data%shdc(1,curve_id2)       ! set to maximum value. do not extrapolate
            endif
          endif
          ...
          !deduce z (may be useful for debug)
          !---bound1 = log10(pblast%pblast_data%rw3(idx1))
          !---bound2 = log10(pblast%pblast_data%rw3(idx2))
          !---logres =  (one-lambda)*bound1+lambda*bound2
          !---z = exp(logres*log10_)
