...
CDECL void cpp_get_message_(int *I, int *MSG_ID, int *MSG_TYPE, char *MSG_DESCR, char *FILE_NAME, int *LINE_NB, char *MSG_BLOCK, char *MSG_LINE)
{
    ...
    *MSG_ID=message.GetId();
    if(message.GetId() != 0)
    {
        *MSG_TYPE = message.GetType();
        strcpy(MSG_DESCR,message.GetDescription().c_str());
...
CDECL void CPP_GET_MESSAGE(int *I, int *MSG_ID, int *MSG_TYPE, char *MSG_DESCR, char *FILE_NAME, int *LINE_NB, char *MSG_BLOCK, char *MSG_LINE)
{cpp_get_message_ (I,MSG_ID,MSG_TYPE,MSG_DESCR,FILE_NAME,LINE_NB,MSG_BLOCK,MSG_LINE);}

CDECL void cpp_get_message__ (int *I, int *MSG_ID, int *MSG_TYPE, char *MSG_DESCR, char *FILE_NAME, int *LINE_NB, char *MSG_BLOCK, char *MSG_LINE)
{cpp_get_message_ (I,MSG_ID,MSG_TYPE,MSG_DESCR,FILE_NAME,LINE_NB,MSG_BLOCK,MSG_LINE);}
