...
MvDataDynamicArrayFeature_t::MvDataDynamicArrayFeature_t(const string &name,int nb_features,int size) :
  MvDataArrayFeature_t(DFT_DYNAMIC_ARRAY,name,nb_features,size),
  mySizeFeaturePtr(NULL)
{}

MvDataDynamicArrayFeature_t::~MvDataDynamicArrayFeature_t() {
}


/* --------- Output in an output stream --------- */

ostream &MvDataDynamicArrayFeature_t::display(ostream &os,const MvDescriptor_t &descr,int level) const {
  int i;
