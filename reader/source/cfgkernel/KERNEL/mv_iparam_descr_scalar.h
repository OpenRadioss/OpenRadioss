...
#ifndef MV_IPARAM_DESCR_SCALAR_H
#define MV_IPARAM_DESCR_SCALAR_H
...
class MvIParamDescrScalar_t : public MvIParamDescr_t {

public: /** @name Constructors and destructor */
  //@{
  /// Constructor
  MvIParamDescrScalar_t(int ikeyword,MvIParamAccess_e access,const string &name,const string &comment);
  /// Destructor
  virtual inline ~MvIParamDescrScalar_t() {}
  //@}

public: /** @name MvIParam_t redefined methods */
  //@{
  /// Gets the type
  virtual inline MvIParamType_e getType() const { return IPT_SCALAR; }
  //@}
...
#endif //MV_IPARAM_DESCR_SCALAR_H
