...
/// Data accelero feature
class MvDataAcceleroFeature_t : public MvDataObjectFeature_t {

public: /** @name Constructors & destructor */
//@{
  /// Constructor
  MvDataAcceleroFeature_t(const string &name,int ikeyword);
  /// Destructor
  virtual ~MvDataAcceleroFeature_t();
//@}
...
#endif //MV_DATA_ACCELERO_FEATURE_H
