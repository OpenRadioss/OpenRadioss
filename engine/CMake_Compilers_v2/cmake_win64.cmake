...
# Vectorization flags for win64 (AVX2)
set(VECT_OPT "/QaxCORE-AVX2,COMMON-AVX512 /Qfma- /Qimf-use-svml:true /align:array64byte")
...
set(F_O1_AXSSE3 "/nologo /Qaxsse3 /Qopenmp /O1 /fp:precise /Qfma- /Qftz /Qimf-use-svml:true /align:array64byte ${precision_flag} ${Fortran_base} -DMETIS5 ${mumps_flag} ${mpi_flag} ${cppmach} ${cpprel} ${ADF}")
set(F_O2_AXSSE3 "/nologo /Qaxsse3 /Qopenmp /O2 /fp:precise /Qfma- /Qftz /Qimf-use-svml:true /align:array64byte ${precision_flag} ${Fortran_base} -DMETIS5 ${mumps_flag} ${mpi_flag} ${cppmach} ${cpprel} ${ADF}")
set(F_O3_AXSSE3 "/nologo /Qaxsse3 /Qopenmp /O3 /fp:precise /Qfma- /Qftz /Qimf-use-svml:true /align:array64byte ${precision_flag} ${Fortran_base} -DMETIS5 ${mumps_flag} ${mpi_flag} ${cppmach} ${cpprel} ${ADF}")
