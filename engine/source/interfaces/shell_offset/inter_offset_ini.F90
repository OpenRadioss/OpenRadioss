...
! ----------------------------------------------------------------------------------------------------------------------
          ...
          integer, intent (in)                             :: nparg            !< 1st dim of iparg
          integer, intent (in)                             :: npropg           !< 1st dim of geo
          integer, intent (in)                             :: numgeo           !< number of prop
          integer, intent (in)                             :: numelc           !< number shell 4n element
          integer, intent (in)                             :: nixc             !< 1st dim of ixc
          integer, intent (in)                             :: numeltg          !< number shell 3n element
          integer, intent (in)                             :: nixtg            !< 1st dim of ixtg
...
! ----------------------------------------------------------------------------------------------------------------------
          ...
          call spmd_allreduce(nsh_oset, nsh_offset_global, 1 , SPMD_MAX)
          if(nsh_offset_global > 0) then
            sh_offset_tab%active = .true.
          else
            sh_offset_tab%active = .false.
          endif
          if (nsh_offset_global >0) then
