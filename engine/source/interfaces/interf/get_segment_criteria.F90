...
!                                                   arguments
! ----------------------------------------------------------------------------------------------------------------------
          real(kind=WP), intent(inout) :: criteria
          real(kind=WP), dimension(3), intent(in) :: local_normal !< normal of the local segment
          real(kind=WP), dimension(3), intent(in) :: remote_normal !< normal of the remote segment
! ----------------------------------------------------------------------------------------------------------------------
!                                                   local variables
! ----------------------------------------------------------------------------------------------------------------------
