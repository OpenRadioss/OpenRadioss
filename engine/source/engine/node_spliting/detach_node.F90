...
!          write(6,*) "Mirror Detaching",nodes%itab(node_id),"to new node [not yet defined]",&
!            "on rank",ispmd,"with",n_pon_recv,"recv rows from owner rank",owning_rank
...
!            write(6,*) "1 Detaching",nodes%itab(node_id),"to new node [not yet defined]"
            call detach_node_from_shells(nodes, node_id, elements, shell_list, list_size, &
...
!            write(6,*) "3 Detaching",nodes%itab(node_id),"to new node [not yet defined]"
            call detach_node_from_shells(nodes, node_id, elements, shell_list, list_size, &
