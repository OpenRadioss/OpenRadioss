...
void c_h3d_create_skin_tensor_datatype_(int *cpt_data, char *name1, int *size1, int *info, char *name2, int *size2,
...
/*    if( strncmp(cname,"Strain",6)  == 0 ) tensor_type = H3D_DS_STRAIN; */
    ...
    try {
        ...
        rc = Hyper3DDatatypePools(h3d_file, *cpt_data , skin_poolname_id, 1, 
...
void _FCALL C_H3D_CREATE_SKIN_TENSOR_DATATYPE(int *cpt_data, char *name1, int *size1, int *info, char *name2, int *size2,
                                               int *layer, int *nuvar, int *ir, int *is, int *it,
                                               char *comment, int *s_comment)
{c_h3d_create_skin_tensor_datatype_ (cpt_data, name1, size1, info, name2, size2, layer, nuvar, ir, is, it, comment, s_comment);}

void c_h3d_create_skin_tensor_datatype__ (int *cpt_data, char *name1, int *size1, int *info, char *name2, int *size2,
                                           int *layer, int *nuvar, int *ir, int *is, int *it,
                                           char *comment, int *s_comment)
{c_h3d_create_skin_tensor_datatype_ (cpt_data, name1, size1, info, name2, size2, layer, nuvar, ir, is, it, comment, s_comment);}

void c_create_skin_tensor_datatype (int *cpt_data, char *name1, int *size1, int *info, char *name2, int *size2,
                                     int *layer, int *nuvar, int *ir, int *is, int *it,
                                     char *comment, int *s_comment)
{c_h3d_create_skin_tensor_datatype_ (cpt_data, name1, size1, info, name2, size2, layer, nuvar, ir, is, it, comment, s_comment);}
}
