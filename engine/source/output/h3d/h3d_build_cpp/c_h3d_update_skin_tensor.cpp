...
/*=================================================================*/
/*        C_H3D_UPDATE_H3DFILE_SHELL_TENSOR                        */
/*=================================================================*/

void c_h3d_update_skin_tensor_(my_real *TT,int *IH3D, int *NUMEL, 
...
//
    ...
    try {
        ...
        float elem_result[3] = { 0.0f, 0.0f, 0.0f};
...
void _FCALL C_H3D_UPDATE_SKIN_TENSOR(my_real *TT,int *IH3D,  int *NUMEL, 
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *IS_WRITTEN)
{c_h3d_update_skin_tensor_ (TT,IH3D,NUMEL,FUNC,ID_ELEM,CPT_DATATYPE,IS_WRITTEN);}

void c_h3d_update_skin_tensor__ (my_real *TT,int *IH3D,  int *NUMEL, 
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE,int *IS_WRITTEN)
{c_h3d_update_skin_tensor_ (TT,IH3D,NUMEL,FUNC,ID_ELEM,CPT_DATATYPE,IS_WRITTEN);}

void c_h3d_update_skin_tensor (my_real *TT,int *IH3D, int *NUMEL, 
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *IS_WRITTEN)
{c_h3d_update_skin_tensor_ (TT,IH3D,NUMEL,FUNC,ID_ELEM,CPT_DATATYPE,IS_WRITTEN);}
