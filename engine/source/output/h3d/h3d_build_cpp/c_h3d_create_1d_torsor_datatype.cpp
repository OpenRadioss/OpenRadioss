...
/*=================================================================*/
/*        C_H3D_CREATE_1d_torsor_DATATYPE                       */
/*=================================================================*/

void c_h3d_create_1d_torsor_datatype_(int *cpt_data, char *name, int *size, int *info1, char *name1, int *size1,
...
void _FCALL C_H3D_CREATE_1D_TORSOR_DATATYPE(int *cpt_data, char *name, int *size, int *info1, char *name1, int *size1,
                                            char *comment, int *s_comment)
{c_h3d_create_1d_torsor_datatype_ (cpt_data, name, size, info1, name1, size1, comment, s_comment);}

void c_h3d_create_1d_torsor_datatype__ (int *cpt_data, char *name, int *size, int *info1, char *name1, int *size1,
                                        char *comment, int *s_comment)
{c_h3d_create_1d_torsor_datatype_ (cpt_data, name, size, info1, name1, size1, comment, s_comment);}

void c_create_1d_torsor_datatype (int *cpt_data, char *name, int *size, int *info1, char *name1, int *size1,
                                  char *comment, int *s_comment)
{c_h3d_create_1d_torsor_datatype_ (cpt_data, name, size, info1, name1, size1, comment, s_comment);}
