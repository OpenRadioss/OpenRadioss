...
/*=================================================================*/
/*        C_H3D_UPDATE_sph_TENSOR                                */
/*=================================================================*/

void c_h3d_update_sph_tensor_(my_real *TT,int *IH3D, int *ITAB,int *NUMSPH, int *IPARTS,
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *IS_WRITTEN)
{
    int i;
    int offset;
    H3D_ID elem_id;
...
void _FCALL C_H3D_UPDATE_SPH_TENSOR(my_real *TT,int *IH3D, int *ITAB,int *NUMSPH, int *IPARTS,
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *IS_WRITTEN)
{c_h3d_update_sph_tensor_ (TT,IH3D,ITAB,NUMSPH,IPARTS,FUNC,ID_ELEM,CPT_DATATYPE,IS_WRITTEN);}

void c_h3d_update_sph_tensor__ (my_real *TT,int *IH3D, int *ITAB,int *NUMSPH, int *IPARTS,
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *IS_WRITTEN)
{c_h3d_update_sph_tensor_ (TT,IH3D,ITAB,NUMSPH,IPARTS,FUNC,ID_ELEM,CPT_DATATYPE,IS_WRITTEN);}

void c_h3d_update_sph_tensor (my_real *TT,int *IH3D, int *ITAB,int *NUMSPH, int *IPARTS,
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *IS_WRITTEN)
{c_h3d_update_sph_tensor_ (TT,IH3D,ITAB,NUMSPH,IPARTS,FUNC,ID_ELEM,CPT_DATATYPE,IS_WRITTEN);}
