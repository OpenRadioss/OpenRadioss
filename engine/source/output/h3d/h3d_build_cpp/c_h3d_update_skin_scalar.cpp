...
/*=================================================================*/
/*        C_H3D_UPDATE_H3DFILE_skin_SCALAR                        */
/*=================================================================*/

void c_h3d_update_skin_scalar_(my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, 
                               my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE,
                               int *NUMELQ , int *IS_WRITTEN)
{
    int i;
    int offset;
    H3D_ID elem_id;
...
void _FCALL C_H3D_UPDATE_SKIN_SCALAR(my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, 
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE,
                           int *NUMELQ , int *IS_WRITTEN)
{c_h3d_update_skin_scalar_ (TT,IH3D,ITAB,NUMNOD,FUNC,ID_ELEM,CPT_DATATYPE,
                            NUMELQ,IS_WRITTEN);}

void c_h3d_update_skin_scalar__ (my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, 
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE,
                           int *NUMELQ , int *IS_WRITTEN)
{c_h3d_update_skin_scalar_ (TT,IH3D,ITAB,NUMNOD,FUNC,ID_ELEM,CPT_DATATYPE,
                           NUMELQ,IS_WRITTEN);}

void c_h3d_update_skin_scalar (my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, 
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE,
                           int *NUMELQ , int *IS_WRITTEN)
{c_h3d_update_skin_scalar_ (TT,IH3D,ITAB,NUMNOD,FUNC,ID_ELEM,CPT_DATATYPE,
                           NUMELQ,IS_WRITTEN);}
