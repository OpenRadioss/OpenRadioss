...
/*=================================================================*/
/*        C_H3D_UPDATE_H3DFILE_oned_scalar                        */
/*=================================================================*/

void c_h3d_update_oned_scalar_(my_real *TT,int *IH3D, int *ITAB, int *NUMELT, int *NUMELP, int *NUMELR, 
...
void _FCALL C_H3D_UPDATE_ONED_SCALAR(my_real *TT,int *IH3D, int *ITAB, int *NUMELT, int *NUMELP, int *NUMELR, 
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *ITY_ELEM, int *IS_WRITTEN)
{c_h3d_update_oned_scalar_ (TT,IH3D,ITAB,NUMELT,NUMELP,NUMELR,FUNC,ID_ELEM,CPT_DATATYPE,ITY_ELEM,IS_WRITTEN);}

void c_h3d_update_oned_scalar__ (my_real *TT,int *IH3D, int *ITAB, int *NUMELT, int *NUMELP, int *NUMELR, 
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *ITY_ELEM, int *IS_WRITTEN)
{c_h3d_update_oned_scalar_ (TT,IH3D,ITAB,NUMELT,NUMELP,NUMELR,FUNC,ID_ELEM,CPT_DATATYPE,ITY_ELEM,IS_WRITTEN);}

void c_h3d_update_oned_scalar (my_real *TT,int *IH3D, int *ITAB, int *NUMELT, int *NUMELP, int *NUMELR, 
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *ITY_ELEM, int *IS_WRITTEN)
{c_h3d_update_oned_scalar_ (TT,IH3D,ITAB,NUMELT,NUMELP,NUMELR,FUNC,ID_ELEM,CPT_DATATYPE,ITY_ELEM,IS_WRITTEN);}
