...
void c_h3d_eroded_solid_(my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, int *IXS, int *NIXS, int *NUMELS, int *IPARTS,
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE,
                           int *ITY_ELEM, int *NUMELQ , int *NUMELT , int *NUMELP , int *NUMELR)
{
    int i;
    int offset;
    H3D_ID elem_id;
...
void _FCALL C_H3D_ERODED_SOLID(my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, int *IXS, int *NIXS, int *NUMELS, int *IPARTS,
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE,
                           int *ITY_ELEM, int *NUMELQ , int *NUMELT , int *NUMELP , int *NUMELR)
{c_h3d_eroded_solid_ (TT,IH3D,ITAB,NUMNOD,IXS,NIXS,NUMELS,IPARTS,FUNC,ID_ELEM,CPT_DATATYPE,ITY_ELEM,
                         NUMELQ,NUMELT,NUMELP,NUMELR);}

void c_h3d_eroded_solid__ (my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, int *IXS, int *NIXS, int *NUMELS, int *IPARTS,
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE,
                           int *ITY_ELEM, int *NUMELQ , int *NUMELT , int *NUMELP , int *NUMELR)
{c_h3d_eroded_solid_ (TT,IH3D,ITAB,NUMNOD,IXS,NIXS,NUMELS,IPARTS,FUNC,ID_ELEM,CPT_DATATYPE,ITY_ELEM,
                         NUMELQ,NUMELT,NUMELP,NUMELR);}

void c_h3d_eroded_solid (my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, int *IXS, int *NIXS, int *NUMELS, int *IPARTS,
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE,
                           int *ITY_ELEM, int *NUMELQ , int *NUMELT , int *NUMELP , int *NUMELR)
{c_h3d_eroded_solid_ (TT,IH3D,ITAB,NUMNOD,IXS,NIXS,NUMELS,IPARTS,FUNC,ID_ELEM,CPT_DATATYPE,ITY_ELEM,
                           NUMELQ,NUMELT,NUMELP,NUMELR);}
...
//
    ...
    try {
        ...
        rc = Hyper3DDatatypePools(h3d_file, *cpt_data , solid_poolname_id, 0, 
...
{c_h3d_create_solid_eroded_ (cpt_data, name, size, info, name1, size1);}
