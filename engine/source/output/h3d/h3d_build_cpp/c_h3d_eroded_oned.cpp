...
{
/*=================================================================*/
/*        C_H3D_UPDATE_oned_SCALAR                                */
/*=================================================================*/

void c_h3d_eroded_oned_(my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, int *IXT, int *NIXT, int *NUMELT, int *IPARTT,
                        int *IXP, int *NIXP, int *NUMELP, int *IPARTP, int *IXR, int *NIXR, int *NUMELR, int *IPARTR,
                        my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *ITY_ELEM)
{
    int i;
    int offset;
    H3D_ID elem_id;
...
void _FCALL C_H3D_ERODED_ONED(my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, int *IXT, int *NIXT, int *NUMELT, int *IPARTT,
                              int *IXP, int *NIXP, int *NUMELP, int *IPARTP, int *IXR, int *NIXR, int *NUMELR, int *IPARTR,
                              my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *ITY_ELEM)
{c_h3d_eroded_oned_ (TT,IH3D,ITAB,NUMNOD,IXT,NIXT,NUMELT,IPARTT,IXP,NIXP,NUMELP,IPARTP,IXR,NIXR,NUMELR,IPARTR,FUNC,ID_ELEM,CPT_DATATYPE,
                     ITY_ELEM);}

void c_h3d_eroded_oned__ (my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, int *IXT, int *NIXT, int *NUMELT, int *IPARTT,
                          int *IXP, int *NIXP, int *NUMELP, int *IPARTP, int *IXR, int *NIXR, int *NUMELR, int *IPARTR,
                          my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *ITY_ELEM)
{c_h3d_eroded_oned_ (TT,IH3D,ITAB,NUMNOD,IXT,NIXT,NUMELT,IPARTT,IXP,NIXP,NUMELP,IPARTP,IXR,NIXR,NUMELR,IPARTR,FUNC,ID_ELEM,CPT_DATATYPE,
                     ITY_ELEM);}

void c_h3d_eroded_oned (my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, int *IXT, int *NIXT, int *NUMELT, int *IPARTT,
                        int *IXP, int *NIXP, int *NUMELP, int *IPARTP, int *IXR, int *NIXR, int *NUMELR, int *IPARTR,
                        my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *ITY_ELEM)
{c_h3d_eroded_oned_ (TT,IH3D,ITAB,NUMNOD,IXT,NIXT,NUMELT,IPARTT,IXP,NIXP,NUMELP,IPARTP,IXR,NIXR,NUMELR,IPARTR,FUNC,ID_ELEM,CPT_DATATYPE,
                     ITY_ELEM);}
...
{c_h3d_create_oned_eroded_ (cpt_data, name, size, info, name1, size1);}
