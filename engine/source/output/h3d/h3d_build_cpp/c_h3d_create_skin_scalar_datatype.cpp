...
void c_h3d_create_skin_scalar_datatype_(int *cpt_data, char *name1, int *size1, int *info, char *name2, int *size2, int *nuvar,
...
void _FCALL C_H3D_CREATE_SKIN_SCALAR_DATATYPE(int *cpt_data, char *name1, int *size1, int *info, char *name2, int *size2, int *nuvar,
                                              char *comment, int *s_comment)
{c_h3d_create_skin_scalar_datatype_ (cpt_data, name1, size1, info, name2, size2, nuvar, comment, s_comment);}

void c_h3d_create_skin_scalar_datatype__ (int *cpt_data, char *name1, int *size1, int *info, char *name2, int *size2, int *nuvar,
                                          char *comment, int *s_comment)
{c_h3d_create_skin_scalar_datatype_ (cpt_data, name1, size1, info, name2, size2, nuvar, comment, s_comment);}

void c_create_skin_scalar_datatype (int *cpt_data, char *name1, int *size1, int *info, char *name2, int *size2, int *nuvar,
                                    char *comment, int *s_comment)
{c_h3d_create_skin_scalar_datatype_ (cpt_data, name1, size1, info, name2, size2, nuvar, comment, s_comment);}
}
