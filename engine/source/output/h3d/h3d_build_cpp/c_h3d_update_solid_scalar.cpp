...
void c_h3d_update_solid_scalar_(my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, int *IXS, int *NIXS, int *NUMELS, int *IPARTS,
...
void _FCALL C_H3D_UPDATE_SOLID_SCALAR(my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, int *IXS, int *NIXS, int *NUMELS, int *IPARTS,
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE,
                           int *ITY_ELEM, int *NUMELQ , int *NUMELT , int *NUMELP , int *NUMELR, int *IS_WRITTEN)
{c_h3d_update_solid_scalar_ (TT,IH3D,ITAB,NUMNOD,IXS,NIXS,NUMELS,IPARTS,FUNC,ID_ELEM,CPT_DATATYPE,ITY_ELEM,
                         NUMELQ,NUMELT,NUMELP,NUMELR,IS_WRITTEN);}

void c_h3d_update_solid_scalar__ (my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, int *IXS, int *NIXS, int *NUMELS, int *IPARTS,
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE,
                           int *ITY_ELEM, int *NUMELQ , int *NUMELT , int *NUMELP , int *NUMELR, int *IS_WRITTEN)
{c_h3d_update_solid_scalar_ (TT,IH3D,ITAB,NUMNOD,IXS,NIXS,NUMELS,IPARTS,FUNC,ID_ELEM,CPT_DATATYPE,ITY_ELEM,
                         NUMELQ,NUMELT,NUMELP,NUMELR,IS_WRITTEN);}

void c_h3d_update_solid_scalar (my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, int *IXS, int *NIXS, int *NUMELS, int *IPARTS,
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE,
                           int *ITY_ELEM, int *NUMELQ , int *NUMELT , int *NUMELP , int *NUMELR, int *IS_WRITTEN)
{c_h3d_update_solid_scalar_ (TT,IH3D,ITAB,NUMNOD,IXS,NIXS,NUMELS,IPARTS,FUNC,ID_ELEM,CPT_DATATYPE,ITY_ELEM,
                           NUMELQ,NUMELT,NUMELP,NUMELR,IS_WRITTEN);}
