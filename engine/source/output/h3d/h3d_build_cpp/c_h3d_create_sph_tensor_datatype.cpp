...
/*=================================================================*/
/*        C_H3D_CREATE_sph_TENSOR_DATATYPE                       */
/*=================================================================*/

void c_h3d_create_sph_tensor_datatype_(int *cpt_data, char *name1, int *size1, int *info, char *name2, int *size2, int *nuvar,
                                       char *comment, int *s_comment)
{
    ...
    try {
        ...
        rc = Hyper3DDatatypePools(h3d_file, *cpt_data , sphcell_poolname_id, 0, 
...
void _FCALL C_H3D_CREATE_SPH_TENSOR_DATATYPE(int *cpt_data, char *name1, int *size1, int *info, char *name2, int *size2, int *nuvar,
                                             char *comment, int *s_comment)
{c_h3d_create_sph_tensor_datatype_ (cpt_data, name1, size1, info, name2, size2, nuvar, comment, s_comment);}

void c_h3d_create_sph_tensor_datatype__ (int *cpt_data, char *name1, int *size1, int *info, char *name2, int *size2, int *nuvar,
                                         char *comment, int *s_comment)
{c_h3d_create_sph_tensor_datatype_ (cpt_data, name1, size1, info, name2, size2, nuvar, comment, s_comment);}

void c_create_sph_tensor_datatype (int *cpt_data, char *name1, int *size1, int *info, char *name2, int *size2, int *nuvar,
                                   char *comment, int *s_comment)
{c_h3d_create_sph_tensor_datatype_ (cpt_data, name1, size1, info, name2, size2, nuvar, comment, s_comment);}
}
