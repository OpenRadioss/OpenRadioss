...
/*=================================================================*/
/*        C_H3D_UPDATE_H3DFILE_nodal_SCALAR                        */
/*=================================================================*/

void c_h3d_update_nodal_scalar_(my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, my_real *FUNC ,int *ID_NODE,int *CPT_DATATYPE, int *IS_WRITTEN)
{
    int i;
    int offset;
    H3D_ID node_id;
...
void _FCALL C_H3D_UPDATE_NODAL_SCALAR(my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, my_real *FUNC ,int *ID_NODE,int *CPT_DATATYPE, int *IS_WRITTEN)
{c_h3d_update_nodal_scalar_ (TT,IH3D,ITAB,NUMNOD,FUNC,ID_NODE,CPT_DATATYPE,IS_WRITTEN);}

void c_h3d_update_nodal_scalar__ (my_real *TT,int *IH3D, int *ITAB, int *NUMNOD, my_real *FUNC ,int *ID_NODE,int *CPT_DATATYPE, int *IS_WRITTEN)
{c_h3d_update_nodal_scalar_ (TT,IH3D,ITAB,NUMNOD,FUNC,ID_NODE,CPT_DATATYPE,IS_WRITTEN);}
