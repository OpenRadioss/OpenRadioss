...
void c_h3d_create_nodal_vector_datatype_(int *cpt_data, char *name, int *size, int *info1, int *info2, char *name1, int *size1,
...
void _FCALL C_H3D_CREATE_NODAL_VECTOR_DATATYPE(int *cpt_data, char *name, int *size, int *info1, int *info2, char *name1, int *size1,
                                         char *comment, int *s_comment)
{c_h3d_create_nodal_vector_datatype_ (cpt_data, name, size, info1, info2, name1, size1, comment, s_comment);}

void c_h3d_create_nodal_vector_datatype__ (int *cpt_data, char *name, int *size, int *info1, int *info2, char *name1, int *size1,
                                         char *comment, int *s_comment)
{c_h3d_create_nodal_vector_datatype_ (cpt_data, name, size, info1, info2, name1, size1, comment, s_comment);}

void c_create_nodal_vector_datatype (int *cpt_data, char *name, int *size, int *info1, int *info2, char *name1, int *size1,
                                         char *comment, int *s_comment)
{c_h3d_create_nodal_vector_datatype_ (cpt_data, name, size, info1, info2, name1, size1, comment, s_comment);}
