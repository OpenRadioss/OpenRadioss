...
void c_h3d_update_skin_vector_(my_real *TT,int *IH3D, int *NUMEL, 
...
void _FCALL C_H3D_UPDATE_SKIN_VECTOR(my_real *TT,int *IH3D,  int *NUMEL, 
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *IS_WRITTEN)
{c_h3d_update_skin_vector_ (TT,IH3D,NUMEL,FUNC,ID_ELEM,CPT_DATATYPE,IS_WRITTEN);}

void c_h3d_update_skin_vector__ (my_real *TT,int *IH3D,  int *NUMEL, 
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE,int *IS_WRITTEN)
{c_h3d_update_skin_vector_ (TT,IH3D,NUMEL,FUNC,ID_ELEM,CPT_DATATYPE,IS_WRITTEN);}

void c_h3d_update_skin_vector (my_real *TT,int *IH3D, int *NUMEL, 
                           my_real *FUNC ,int *ID_ELEM,int *CPT_DATATYPE, int *IS_WRITTEN)
{c_h3d_update_skin_vector_ (TT,IH3D,NUMEL,FUNC,ID_ELEM,CPT_DATATYPE,IS_WRITTEN);}
