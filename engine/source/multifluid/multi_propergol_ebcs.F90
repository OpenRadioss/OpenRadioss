...
! ======================================================================================================================
      ...
      SUBROUTINE MULTI_PROPERGOL_EBCS(ITASK, EBCS_ID, MULTI_FVM, NELEM, ELEM_LIST, FACE_LIST, &
                                ...
                                NUMELS, NUMELQ, NUMELTG, NUMNOD, NCYCLE, NUMMAT, MAT_PARAM)
! ----------------------------------------------------------------------------------------------------------------------
!                                                   Modules
! ----------------------------------------------------------------------------------------------------------------------
      USE MULTI_FVM_MOD
...
! ----------------------------------------------------------------------------------------------------------------------
      ...
      TYPE(MATPARAM_STRUCT_), INTENT(IN), DIMENSION(NUMMAT) :: MAT_PARAM !material data structure
! ----------------------------------------------------------------------------------------------------------------------
!                                                   Local Variables
! ----------------------------------------------------------------------------------------------------------------------
            ...
            DO IMAT = 1, NBMAT
               ...
               IF (PHASE_ALPHAJJ(IMAT)  >  ZERO) THEN
                 CALL MULTI_SUBMATLAW( &
                        ...
                        DUMMY,              DUMMY,                        NPF,                     TF, &
                        DUMMY,              1,                            MAT_PARAM(LOCAL_MATID(IMAT)))
