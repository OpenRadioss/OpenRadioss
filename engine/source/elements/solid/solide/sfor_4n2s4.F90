...
!                                                   Local variables
! ----------------------------------------------------------------------------------------------------------------------
          integer :: i,ifctl,ifctl1,ifc2(mvsiz),ifde_s(mvsiz),itgsub(mvsiz)
!
...
!                                                   Local variables
! ----------------------------------------------------------------------------------------------------------------------
          integer :: i,ifctl1,ifctl,ifc2(mvsiz)
!
          real(kind=WP) :: rx,ry,rz,sx,sy,sz,nx(mvsiz),ny(mvsiz),nz(mvsiz),dx,dy,dz,dn,norm,area,fkt(mvsiz)
! ----------------------------------------------------------------------------------------------------------------------
!                                                   Body
! ----------------------------------------------------------------------------------------------------------------------
!------general info of seg, and sorting by projected distance
