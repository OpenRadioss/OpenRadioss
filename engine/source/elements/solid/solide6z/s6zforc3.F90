...
!-------------------------------------------------------------------------------
          ...
          !< xdp is double prescision, kind = 8 is obligatoire
...
!-------------------------------------------------------------------------------
          ...
          real(kind=wp), dimension(mvsiz) :: jac1,jac2,jac3,jac4,jac5,jac6,jac9
          !< jacobian matrix components j11, j12, j13
...
! c    force wp = 8 to ensure double-precision (64-bit) floating-point calculations, even when compiling in
...
!
          ...
          inloc = iparg(78,ng)
          call my_alloc(var_reg, nel, "var_reg")
!
          !< to be defined
          sz_r1_free = nel
