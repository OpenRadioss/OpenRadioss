...
!Copyright>        commercial version may interest you: https://www.altair.com/radioss/.
      ...
      ! ----------------------------------------------------------------------------------------------------------------------
            ...
            real(kind=WP),              intent(in) :: dt1 !< time step               !< Pressure flag
            ...
            real(kind=wp), dimension(nel), intent(in)    :: volg                  !< Global volume               !< Old volume                !< Volume strain rate              !< Z stress component                 !< Modified volume
            real(kind=wp), dimension(nel), intent(inout) :: off                   !< Element flag
            real(kind=wp), dimension(nel), intent(in)    :: offg                  !< Global element flag
            real(kind=wp), dimension(nel), intent(in)    :: offs                  !< Shell element flag                  !< Volume change             !< Double precision volume
