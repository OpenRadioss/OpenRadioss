...
!Copyright>        commercial version may interest you: https://www.altair.com/radioss/.
      ...
      !||--- uses       -----------------------------------------------------
      !||    PRECISION_MOD ../engine/source/system/precision_mod.F90
      !||    CONSTANT_MOD  ../engine/source/system/constant_mod.F90
      !||    ELBUFDEF_MOD  ../engine/source/elements/common/elbufdef_mod.F90
      !||    MVSIZ_MOD     ../engine/source/system/mvsiz_mod.F90
      !||====================================================================
...
! ----------------------------------------------------------------------------------------------------------------------
  ...
  integer,                     intent(in) :: mtn       
   ...
   real(kind=WP), dimension(npropm,nel)      , intent(in)    :: pm          !< Material properties
   real(kind=WP), dimension(npropg,nel)      , intent(in)    :: geo         !< Geometry properties
   ...
   real(kind=WP), dimension(*)             , intent(inout) :: sigy       !< Internal energy
   real(kind=WP), dimension(nel,6)             , intent(inout) :: sig0        !< Internal energy
   real(kind=WP), dimension(nel,6)           , intent(inout) :: sigold        !< Internal energy
