...
! ----------------------------------------------------------------------------------------------------------------------
          ...
          real(kind=wp) :: ang0, cos_2ang0, cos_ang0, sin_ang0, tan_2ang0,&
            tmp,cos2_ang0
! ----------------------------------------------------------------------------------------------------------------------
!                                                   coding
! ----------------------------------------------------------------------------------------------------------------------
          ...
          func = matparam%table(7)%notable! gxt
          if(func /= 0) then
            ipos(:,1) = vartmp(:,7)
          ...
          func = matparam%table(8)%notable! gxc
          if(func /= 0) then
            ipos(:,1) = vartmp(:,8)
          ...
          func = matparam%table(9)%notable ! gyt
          if(func /= 0) then
            ipos(:,1) = vartmp(:,9)
          ...
          func = matparam%table(10)%notable! gyc
          if(func /= 0) then
            ipos(:,1) = vartmp(:,10)
          ...
          func = matparam%table(11)%notable ! gsl
          if(func /= 0) then
            ipos(:,1) = vartmp(:,11)
          ...
          !
          func =  matparam%table(12)%notable  ! xt0
          ...
          func = matparam%table(14)%notable! gxt0
          if(func /= 0) then
            ipos(:,1) = vartmp(:,14)
          ...
          func = matparam%table(15)%notable! gxc
          if(func /= 0) then
            ipos(:,1) = vartmp(:,15)
