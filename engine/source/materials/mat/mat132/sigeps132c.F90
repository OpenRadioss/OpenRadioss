...
!!======================================================================
          ...
          if(mat_param%table(1)%notable > 0) then  ! function for shear
            ipos(:,1) = vartmp(:,1)
            do i=1,nel
          ...
          do n =1,ndx
            gama_ab_m = -HUGE(gama_ab_m) ! needed to avoid being used without being initialized
            sigma_ab_m = -HUGE(sigma_ab_m) ! needed to avoid being used without being initialized
            i = indx(n)
