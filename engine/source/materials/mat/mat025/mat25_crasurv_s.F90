...
! ----------------------------------------------------------------------------------------------------------------------
!     reduction of sig based on criterion wpla_old >= wplamx
! ----------------------------------------------------------------------------------------------------------------------
#include   "nofusion.inc"
          do i=1,nel
...
!
              ...
              else if( abs(t3(i)) > abs(t1(i))) then
                id = 3
              end if
              select case(id)
               case(1)
