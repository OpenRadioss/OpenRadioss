...
!===============================================================================
      ...
      !||====================================================================
      !||    sigeps128c   ../engine/source/materials/mat/mat093/sigeps128c.F
      !||--- calls      -----------------------------------------------------
      !||====================================================================
...
!-----------------------------------------------
      ...
      my_real ,dimension(nuvar,nel)   ,intent(inout) :: uvar      !< state variables
      integer ,dimension(nvartmp,nel) ,intent(inout) :: vartmp    !< temporary internal variables
