...
!||====================================================================
      module cutting_plane_beams_mod
! \brief Cutting plane return mapping for beams in /MAT/LAW131
! \details Perform the cutting plane semi-implicit return mapping algorithm
!          for beam elements in /MAT/LAW131.
      contains
!||====================================================================
...
!||====================================================================
      subroutine cutting_plane_beams(                                          &
...
!----------------------------------------------------------------
        ...
        real(kind=WP), dimension(nel) :: pla0,normxx,normyy,normzz,normxy,     &
          ...
          dsigy_dlam,dsigbxx_dlam,dsigbxy_dlam,dsigbzx_dlam,                   &
          ...
          sig_dseqdsig,epsdot,dav,deve1,deve2,deve3,deve4,dpla,rho,shf,soundsp
...
!
              ...
              dsigzx_dlam(ii) = -(cstf(i,6,1)*normxx_i(ii) +                   &
                                  cstf(i,6,4)*normxy_i(ii) +                   &
...
!
              ...
              !<  --------------------------------------------------------------
              sig_dseqdsig(ii) = signxx(i)*normxx_i(ii) +                      &
                                 signxy(i)*normxy_i(ii) +                      &
                                 signzx(i)*normzx_i(ii)
...
!
       end subroutine cutting_plane_beams
       end module cutting_plane_beams_mod