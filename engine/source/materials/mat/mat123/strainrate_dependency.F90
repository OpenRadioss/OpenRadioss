...
!||====================================================================
!||    strainrate_dependency_mod         ../engine/source/materials/mat/mat123/strainrate_dependency_mod.F90
!||--- called by ------------------------------------------------------
...
! ---------------------------------------------------------------------------------------------------------------------- 
          ...
          real(kind=wp), dimension(nel), intent(inout) :: thetai !< misallignement angle
          !
      ...
      !yt rate computation
       ...
       !! mut = -one/tan(two*ang0)
        do i=1,nel
          ...
          thetac = atan(thetac)  
          ! computing the initial misallignement angle 
          ipos(1,1)= 1   
          theta = zero
