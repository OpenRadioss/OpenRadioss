...
! ----------------------------------------------------------------------------------------------------------------------          
      integer :: i,nfail,nkey,ipos1(1,1),ipos(nel,1),type,ndx,n,int_ratio,debug,nfunc
...
!!======================================================================
        debug = 0  ! just to check plan failure 
          ! Material parameters
      ...
      !
       ...
       ioff_duct(1:nel) = one
       !
       if(time == zero) uvar(1:nel,16) = sqrt(npg*area(1:nel))  ! carateristic lenght at first step
