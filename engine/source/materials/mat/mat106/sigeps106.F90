...
!----------------------------------------------------------------
      ...
      real(kind = WP) :: ddep,dfdsig2,sig_dfdsig,tempr
      real(kind = 8)  :: dphi_dlam
...
!  
              ...
              !-----------------------------------------------------------------
              signxx(i) = signxx(i) - two*shear(i)*dpxx(i)
              signyy(i) = signyy(i) - two*shear(i)*dpyy(i)
              signzz(i) = signzz(i) - two*shear(i)*dpzz(i)
