...
contains
   ...
   &npropmi ,npropm  ,npropg,imon_mat ,numgeo   ,numstack, &
   &dt1       ,tt ,nxlaymax,idel7nok ,userl_avail,maxfunc,&
   &nummat,varnl_npttot,sbufmat  ,sdir_a   ,sdir_b   ,stf,nparg,snpc)
!-----------------------------------------------
!   m o d u l e s
!-----------------------------------------------
      use law_usersh
