...
/* Routine cinit29 */
         sprintf(rname,"CINI29");
         cini29=(void*)GetProcAddress(userlibhandler,rname);

/* Routine cinit30 */
         sprintf(rname,"CINI30");
         cini30=(void*)GetProcAddress(userlibhandler,rname);

/* Routine cinit31 */
         sprintf(rname,"CINI31");
         cini31=(void*)GetProcAddress(userlibhandler,rname);
  ...
  *return_code = 0;
  ...
  switch (*igtyp){
    case 29:
      if (cini29){ 
            (*cini29)( 
              nel    ,nnod   ,nuvar  ,iprop   ,imat  ,solid_id,
              eint   ,vol    ,uvar   ,off     ,rho   ,sig,
              xx     ,yy     ,zz     ,vx      ,vy    ,vz,
              vrx    ,vry    ,vrz    ,mas,inn ,
              stifm  ,stifr  ,viscm  ,viscr);
            *return_code = 1;
