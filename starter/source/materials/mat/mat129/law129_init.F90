...
!===============================================================================
          ...
          eps0    = mat_param%uparam(21)
!------------------------------------------
          if (crp_law == 3) then    ! strain hardening Newton creep law is used
            uvar(1:nel,2) = eps0    ! initialize microstructural creep strain
          endif                                                   
!-------------
          return
        end subroutine law129_init
      end module law129_init_mod
