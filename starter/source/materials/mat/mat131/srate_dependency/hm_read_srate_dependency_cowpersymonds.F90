...
!||====================================================================
        subroutine hm_read_srate_dependency_cowpersymonds(                     &
...
!----------------------------------------------------------------
          real(kind=WP) :: c,p,fcut
!===============================================================================
!     
          !===================================================================
          !< Cowper-Symonds strain rate dependency parameters
          !===================================================================
          call hm_get_float_array_index("SRATE_COWPER_C"   ,c      ,ikey,is_available,lsubmodel,unitab)
          call hm_get_float_array_index("SRATE_COWPER_P"   ,p      ,ikey,is_available,lsubmodel,unitab)
          ...
          if (is_encrypted)then
            ...
            write(iout,1000) c,p,vpflag,fcut
          endif
! ------------------------------------------------------------------------------
1000 format(/                                                                  &
          5X,"-------------------------------------------------------",/       &
          5X,"COWPER-SYMONDS STRAIN RATE DEPENDENCY                  ",/,      &
          5X,"-------------------------------------------------------",/,      &
          5X,"STRAIN-RATE DEPENDENCY PARAMETER (C) . . . . . . . . .=",1PG20.13/&
          5X,"STRAIN-RATE DEPENDENCY EXPONENT  (P) . . . . . . . . .=",1PG20.13/&
...
! -------------------------------------------------------------------------------
        end subroutine hm_read_srate_dependency_cowpersymonds
      end module hm_read_srate_dependency_cowpersymonds_mod