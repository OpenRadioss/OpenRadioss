...
!       
          ...
          !===================================================================
          call hm_get_float_array_index("THERM_JCOOK_TREF" ,tref   ,ikey,is_available,lsubmodel,unitab)
          call hm_get_float_array_index("THERM_JCOOK_TMELT",tmelt  ,ikey,is_available,lsubmodel,unitab)
          call hm_get_float_array_index("THERM_JCOOK_M"    ,m      ,ikey,is_available,lsubmodel,unitab)
          ...
          if (is_encrypted)then
            ...
            write(iout,1000) tref,tmelt,m
          endif
! ------------------------------------------------------------------------------
1000 format(/                                                                  &
          5X,"-------------------------------------------------------",/       &
          5X,"JOHNSON-COOK THERMAL SOFTENING                         ",/,      &
          5X,"-------------------------------------------------------",/,      &
          5X,"REFERENCE TEMPERATURE (TREF) . . . . . . . . . . . . .=",1PG20.13/&
          5X,"MELTING TEMPERATURE (TMELT). . . . . . . . . . . . . .=",1PG20.13/&
          5X,'SOFTENING EXPONENT (M) . . . . . . . . . . . . . . . .=',1PG20.13/)
! -------------------------------------------------------------------------------
        end subroutine hm_read_therm_softening_johnsoncook
      end module hm_read_therm_softening_johnsoncook_mod