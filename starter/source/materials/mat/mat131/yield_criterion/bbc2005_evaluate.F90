...
!----------------------------------------------------------------
            ...
            do i = 1, 3
                ...
                ! Smoth the singularity at lam = 0 and psi = 0 by adding a small number
                ...
                Func_F = Func_F**(1.0 / real(k2, 8))

               
                Func_G = a * (((N-P)*term_NP/lam + L + M) * lam_gam_p**k2m1 + &
                              ((N-P)*term_NP/lam - L - M) * lam_gam_m**k2m1 ) + &
                         b * (((N-P)*term_NP/lam + (Q-R)*term_QR/psi) * lam_psi_p**k2m1 + &
                              ((N-P)*term_NP/lam - (Q-R)*term_QR/psi) * lam_psi_m**k2m1 )
            ...
            Func_G = a * ((N*(N-P)/lam + L) * lam_gam_p**k2m1 + &
                          (N*(N-P)/lam - L) * lam_gam_m**k2m1 ) + &
                     b * ((N*(N-P)/lam + Q*(Q-R)/psi) * lam_psi_p**k2m1 + &
                          (N*(N-P)/lam - Q*(Q-R)/psi) * lam_psi_m**k2m1 )
