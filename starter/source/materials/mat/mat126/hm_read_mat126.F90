...
!    
          ...
          matparam%bulk       = k0
          matparam%uparam(1)  = aa
          matparam%uparam(2)  = bb
          matparam%uparam(3)  = nn
          matparam%uparam(4)  = fc
          matparam%uparam(5)  = t0
          matparam%uparam(6)  = cc
          matparam%uparam(7)  = eps0
          matparam%uparam(8)  = sfmax
          matparam%uparam(9)  = efmin
          matparam%uparam(10) = pc
          matparam%uparam(11) = muc
          matparam%uparam(12) = pl
          matparam%uparam(13) = mul
          matparam%uparam(14) = k1
          matparam%uparam(15) = k2
          matparam%uparam(16) = k3
          matparam%uparam(17) = d1
