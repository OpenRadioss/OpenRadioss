...
! ----------------------------------------------------------------------------------------------------------------------
          ...
          real(kind=WP) :: rho0,rhor,fcut,dmin,dmax,e11,e22,e33,g12,g23,g31
          real(kind=WP) :: ecomp,gcomp,bulk,nu,sigy,hcomp,vcomp
          real(kind=WP) :: emx11,emx22,emx33,emx12,emx23,emx31
          real(kind=WP) :: x1scale,x2scale,press_scale
          integer ,dimension(5) :: i11,i22,i33,i12,i23,i31
          integer ,dimension(5,6) :: func_id
          real(kind=WP) ,dimension(5) :: epsp11,epsp22,epsp33,epsp12,epsp23,epsp31
          real(kind=WP) ,dimension(5) :: fac11,fac22,fac33,fac12,fac23,fac31
