...
!      crasurv only
!-----------------------------------------
      mat_param%uparam(30) = eps1t1   !               pm(166)
      mat_param%uparam(31) = eps1t2   !               pm(170)
      mat_param%uparam(32) = eps1c1   !               pm(174)
      mat_param%uparam(33) = eps1c2   !               pm(178)
      mat_param%uparam(34) = eps1t12  !               pm(182)

      mat_param%uparam(35) = eps2t1   !               pm(167)
      mat_param%uparam(36) = eps2t2   !               pm(171)
      mat_param%uparam(37) = eps2c1   !               pm(175)
      mat_param%uparam(38) = eps2c2   !               pm(179)
      mat_param%uparam(39) = eps2t12  !               pm(183)

      mat_param%uparam(55) = sigrst1  !               pm(168)
      mat_param%uparam(56) = sigrst2  !               pm(172)
      mat_param%uparam(57) = sigrsc1  !               pm(176)
      mat_param%uparam(58) = sigrsc2  !               pm(180)
      mat_param%uparam(59) = sigrst12 !               pm(184)

      mat_param%uparam(60) = sigyt1   !               pm(141)
      mat_param%uparam(61) = sigyt2   !               pm(146)
      mat_param%uparam(62) = sigyc1   !               pm(151)
      mat_param%uparam(63) = sigyc2   !               pm(156)
      mat_param%uparam(64) = sigyt12  !               pm(161)
      mat_param%uparam(65) = sigmxt1  !               pm(144)
      mat_param%uparam(66) = sigmxt2  !               pm(149)
      mat_param%uparam(67) = sigmxc1  !               pm(154)
      mat_param%uparam(68) = sigmxc2  !               pm(159)
      mat_param%uparam(69) = sigmxt12 !               pm(164)

      mat_param%uparam(40) = cbt1     !               pm(142)
      mat_param%uparam(41) = cbt2     !               pm(147)
      mat_param%uparam(42) = cbc1     !               pm(152)
      mat_param%uparam(43) = cbc2     !               pm(157)
      mat_param%uparam(44) = cbt12    !               pm(162)

      mat_param%uparam(45) = cnt1     !               pm(143)
      mat_param%uparam(46) = cnt2     !               pm(148)
      mat_param%uparam(47) = cnc1     !               pm(153)
      mat_param%uparam(48) = cnc2     !               pm(158)
      mat_param%uparam(49) = cnt12    !               pm(163)

      mat_param%uparam(50) = cct1     !               pm(145)
      mat_param%uparam(51) = cct2     !               pm(150)
      mat_param%uparam(52) = ccc1     !               pm(155)
      mat_param%uparam(53) = ccc2     !               pm(160)
      mat_param%uparam(54) = cct12    !               pm(165)
                                                             
                                                             
      mat_param%uparam(70) = wplamxt1 !               pm(169)
      mat_param%uparam(71) = wplamxt2 !               pm(173)
      mat_param%uparam(72) = wplamxc1 !               pm(177)
      mat_param%uparam(73) = wplamxc2 !               pm(181)
      mat_param%uparam(74) = wplamxt12!               pm(185)

      ! tsaiwu only
!      pm(44) = one   !  de - not used
!      pm(46) = zero  ! cb 
!      pm(47) = one   ! cn 
!      pm(49) = fmax  !    
!-----------------------------------------
