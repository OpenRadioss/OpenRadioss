...
! ----------------------------------------------------------------------------------------------------------------------
          ...
          real(kind=WP), dimension(eos_param%ntable),intent(in)    :: x2vect    !< x2 vector flag
          real(kind=WP), dimension(eos_param%ntable),intent(in)    :: x3vect    !< x3 vector flag
          real(kind=WP), dimension(eos_param%ntable),intent(in)    :: x4vect    !< x4 vector flag
          ...
          real(kind=WP), dimension(eos_param%ntable),intent(in)    :: fscale    !< function scale factor
