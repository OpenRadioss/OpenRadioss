...
!                                                   local variables
! ----------------------------------------------------------------------------------------------------------------------
          integer :: i,j,k,iadj,ns,nsnj,nsn_i,id,id_j,j_end
          logical :: changed
...
!                                                   local variables
! ----------------------------------------------------------------------------------------------------------------------
          integer :: i,j,ns,jd(6),ifm,isk,ipr
! ======================================================================================================================
...
!                                                   local variables
! ----------------------------------------------------------------------------------------------------------------------
          integer :: i,j,k,nsl,i_add,iad,ns,ipr
! ======================================================================================================================
          ipr = 0
          do i=1,ngrav
            nsl = igrav(1,i)
...
!                                                   local variables
! ----------------------------------------------------------------------------------------------------------------------
          integer :: i,j,k,n,irb,nosys,itype,id,isk,igr,igrs,iad,nsl,part_id,m_id
          integer :: user_unit_id,sub_index,idir,sens_id
          integer :: cpt,sub_id,itagm(nrbykin)
          integer :: ifra,ifm,k1,k2,k3,nb_nodes, id_node
