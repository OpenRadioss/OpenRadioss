...
! ----------------------------------------------------------------------------------------------------------------------
          ...
          real(kind=WP),  intent(in   ),dimension(nshel)          :: thk_g        !< thikness
! ----------------------------------------------------------------------------------------------------------------------
!                                                   Local variables
! ----------------------------------------------------------------------------------------------------------------------
...
!---------
            do while (l<ll) !l=2,ll
              ...
              if (i1 == i1m .and. i2 == i2m .and.l<ll ) then ! double commun line
                ...
                elseif (ichange(ie)*ichange(iem)<0) then 
                  if (ichange(ie)>0.and.icmore(ie)==0) then 
                    if (thk_g(ie)*thk_g(ie)>fourth*l2_e) icmore(ie) = 1
