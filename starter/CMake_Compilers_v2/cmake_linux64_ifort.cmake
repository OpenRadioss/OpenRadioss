########################################
# STARTER - Intel ifort Compiler / linux64
# Legacy Intel compiler (superseded by ifx)
########################################
...
# Compilation flags (debug/chkb/asan/release) — same as ifx
include(${CMAKE_CURRENT_LIST_DIR}/compiler/intel_linux.cmake)

# Link libraries
set(LINK "dl ${xml_lib} ${flexpipe_lib} ${metis_lib} ${reader_lib} ${MKL_lib} ${flexpipe} ${Tet_mesher_lib} ${zlib_lib} ${md5_lib} -ldl -rdynamic -lstdc++")
