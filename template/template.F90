...
!Copyright>        commercial version may interest you: https://www.altair.com/radioss/.
      module my_subroutine_mod
        integer, parameter :: my_constant!< the maximum length of a line of code of python function
! global variable
        integer :: my_global_variable !< global variables should be kept to minimum, should not replace arguments
      contains
! ======================================================================================================================
!                                                   PROCEDURES
! ======================================================================================================================
...
! ----------------------------------------------------------------------------------------------------------------------
          ...
          integer, dimension(:),  allocatable,    intent(inout) :: buffer !< it is possible to allocate arrays within the routine
